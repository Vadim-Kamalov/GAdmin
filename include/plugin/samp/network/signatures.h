...
using incoming_rpc_handler_t = bool(__thiscall*)(void*, utils::zstring_t, int, PlayerID);
...
using encoded_writer_t = void(__thiscall*)(std::uintptr_t, utils::zstring_t, int, BitStream*, int);
