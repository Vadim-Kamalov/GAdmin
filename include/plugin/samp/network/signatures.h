...
using incoming_rpc_handler_t = bool(__thiscall*)(void*, const char*, int, PlayerID);
...
using encoded_writer_t = void(__thiscall*)(std::uintptr_t, const char*, int, BitStream*, int);
