--[[
    ...
    Modified library for working with hotkeys in Dear ImGui.
    Original author: DonHomka

    What exactly has been changed:
        module.Hotkey:       now takes the `ImVec2_size` as the third argument
        module.getKeysName:  now returns the combined array using the separator "+".
    Original file: https://www.blast.hk/threads/57557/ 
