...
void plugin::configuration_initializer::write(const std::filesystem::path& path, const nlohmann::json& json) {
...
nlohmann::json plugin::configuration_initializer::get(const std::filesystem::path& path) {
...
void plugin::configuration_initializer::save() const {
    write(configuration_file, json);
}

void plugin::configuration_initializer::save(std::chrono::milliseconds after) const {
