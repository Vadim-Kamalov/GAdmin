...
auto plugin::misc::features::hide_addresses::try_change_addresses(const std::string_view& input) const
...
auto plugin::misc::features::hide_addresses::is_ip_address(const std::string_view& input) const
    -> bool
{
...
auto plugin::misc::features::hide_addresses::on_server_message(const samp::event<samp::event_id::server_message>& message) const
    -> bool
{
...
auto plugin::misc::features::hide_addresses::on_show_dialog(const samp::event<samp::event_id::show_dialog>& dialog) const
    -> bool
{
    if (!dialog)
        return true;
...
auto plugin::misc::features::hide_addresses::on_event(const samp::event_info& event) -> bool {
